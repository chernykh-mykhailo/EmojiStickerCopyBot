...
copy-started = ⏳ Cloning started for "{$title}"! Link: https://t.me/addstickers/{$name}
copy-progress = ⏳ Cloning "{$title}": {$current}/{$total} ({$percent}%) Link: https://t.me/addstickers/{$name}
