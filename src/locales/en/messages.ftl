msg-start = Hi! I can help you clone or create sticker packs.
    Just send me a link to a sticker pack or a single sticker.
...
btn-cancel = ❌ Cancel
btn-back = 🔙 Back
btn-copy-one = 📥 Add this sticker
btn-copy-one-emoji = 📥 Add this emoji
...
prompt-media = Pack <b>"{$title}"</b> created!
    Send me stickers, photos, or videos you want to add.
    When you're done, press "Done".
err-invalid-name = ❌ Invalid short name. Use only latin characters and numbers.
...
msg-copying-one = ⏳ Copying sticker in {$format} format...
msg-guest-mode = ℹ️ Processing premium content from the replied message...
msg-select-emoji = ✨ I found several premium emojis. Please choose one:
