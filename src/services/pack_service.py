...
class PackService:
    ...
    async def create_new_set(self, user_id: int, name: str, title: str, stickers: list[InputSticker], sticker_type: str):
        ...
        await self.bot.create_new_sticker_set(
            ...
            title=title,
            stickers=stickers,
            sticker_type="regular" if sticker_type != "custom_emoji" else "custom_emoji"
        )
